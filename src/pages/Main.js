      ...
      <div class="bg-stone-800">
        <div class="text-white body-font">
              ...
              <div class="container px-5 py-10 mx-auto">
                <div class="flex flex-wrap -m-4">
                  <div class="p-4 md:w-1/3">
                    <div class="h-full rounded-xl shadow-cla-blue bg-stone-600 overflow-hidden">
                      <img
                      ...
                      <div class="p-6 h-3/5">
                        ...
                        <div class="relative flex items-center flex-wrap ">
                          ...
                          <div class="absolute right-0 font-bold">Goal : 20000$</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="p-4 md:w-1/3">
                    <div class="h-full rounded-xl shadow-cla-violate bg-stone-600 overflow-hidden">
                      <img
                        class="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100"
                        ...
                        alt="blog"></img>
                      <div class="bg-stone-600 p-6 h-3/5">
                        <h2 class="tracking-widest text-xs title-font font-medium text-gray-300 mb-1">Project Description
                        </h2>
                        <h1 class="title-font text-lg font-medium text-slat-200 mb-3">Project Title</h1>
                        ...
                        <div class="relative flex items-center flex-wrap">
                          <button
                            class="bg-gradient-to-r from-zinc-500 to-zinc-600 hover:scale-105 drop-shadow-md px-4 py-1 rounded-lg">Project</button>
                          <div class="absolute right-0 font-bold">Goal : 5000$</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="p-4 md:w-1/3">
                    <div class="h-full rounded-xl shadow-cla-pink bg-stone-600 overflow-hidden">
                      <img
                        class="lg:h-48 md:h-36 w-full object-cover object-center scale-110 transition-all duration-400 hover:scale-100"
                      ...
                      <div class="bg-stone-600  p-6 h-3/5">
                        ...
                        <div class="relative flex items-center flex-wrap">
                          <button
                            class="bg-gradient-to-r from-zinc-500 to-zinc-600 hover:scale-105 drop-shadow-md px-4 py-1 rounded-lg">Project</button>
                          <div class="absolute right-0 font-bold">Goal : To change</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="container px-10 pt-10 mx-auto">
            ...
            <div class="h-full rounded-xl shadow-cla-blue bg-stone-600 mb-10">
              <div class="relative overflow-hidden">
                <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                  <img class="h-56 rounded-xl w-full object-contain sm:h-72 md:h-96 lg:w-full lg:h-full"
                    src={token} alt=""></img>
                </div>
                  ...
                  <main class="mx-auto px-4 mt-10 max-w-7xl px-4 sm:mt-2 sm:px-6 md:mt-4 lg:mt-5 lg:px-8 xl:mt-10">
                    <div class="sm:text-center lg:text-left">
                      <h1 class="text-2xl tracking-tight font-extrabold text-white sm:text-3xl md:text-4xl">
                        <span class="block xl:inline">LCRT fundamental value</span>
                      </h1>
                      <p
        ...
        <div class="2xl:mx-auto 2xl:container mx-4">
          <div class="w-full relative flex items-center justify-center">
            <div class="outline outline-white md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">

...
const projectPage = () => {
  ...
  <div class="bg-black">
    <div class="relative text-white body-font">
           <div class="fixed top-0 lg:right-0 z-10 h-16 md:py-2 lg:py-2.5">
            <div class="pr-8 flex w-96 space-x-4 ">
      ...
      <div class="container px-10 py-10 lg:pr-96 mx-auto">
        <div class="flex">
          <h1 class="text-2xl tracking-tight font-bold px-10 text-white sm:text-3xl md:text-4xl">Project Presentation</h1>
        </div>
